...
<title>Listar Facturas cargadas sin Gestion judicial por Proveedor</title>
...
<!---------------------------------------------->
<form id="form1" name="form1" method="post" action="../views/listaFacturaCG.php"  target="_blank">
