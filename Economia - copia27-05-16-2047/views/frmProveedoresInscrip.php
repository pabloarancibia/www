...
<!-- FORMULARIO -->
<div id="divform">
<form id="form1" name="form1" method="post" action="../Logica/ProveedoresIncrip.php">
  <h4 align="center" class="letra" style="background-color:#7FFF00; color:red;"><strong> <?php
         if(isset($respuesta))
        echo $respuesta;?></strong></h4>
<div id="title_1">SOLICITUD DE INSCRIPCION</div>
<br />
<div id='consultaProv'>
  <input type="button" id="consultaProvNo" value="INSCRIPCION"/>
  <input type="button" id="consultaProvSi" value="REINSCRIPCION"/>
</div>
<div id="datos">
  <label for="nrNroProv" id="lblNroProv" name='lblNroProv'>INGRESE EL NUMERO DE PROVEEDOR</label><br /><br />
  <!-- <input type="radio" name="rdNroProv" value="si">Si<br /> -->
  <!-- <input type="radio" name="rdNroProv" value="no">No<br /><br />-->
  <input type="text" id="nroProv" name="nroProv" class="solo-numero" placeholder="Nro PROVEEDOR"/>
  <br />
  <div id="title">DATOS DE LA EMPRESA</div>
  <div id="datos_1">
    <br class="clear" />
    <label for="entidad">CONDICION ANTE AFIP:  </label>
    <select name="entidad" id="entidad" required="required">
...
<input type="text" class="solo-numero" name="cuit3" id="cuit3" required="required" placeholder="0" />
<input type="text" class="solo-numero" name="conv_multi" id="conv_multi" placeholder="CONV. MULTILATERAL Nº"/>
<br class="clear" />
</div><!-- fin datos 1 -->
<div id="datos_2">
<input type="text" name="nombres" id="nombres" placeholder="DENOMINACION O RAZON SOCIAL" required="required"/>
<input type="email" name="email" id="email" required placeholder="EMAIL" /><br />
<input type="text" name="domicilio" id="domicilio" placeholder="DOMICILIO: Calle" required="required"/>
<input type="text" name="altura" id="altura" class="altura solo-numero" placeholder="Altura" required="required"/>
...
<br class="clear" />
<input type="text" name="localidad" id="localidad" placeholder="LOCALIDAD" required="required"/>
<input type="text" name="tel" id="tel" class="solo-numero" placeholder="TELEFONO" required="required"/>
<input type="text" name="cp" id="cp" class="solo-numero" placeholder="CODIGO POSTAL" required="required"/>
<br class="clear" />
...
<select name="dtos_filiat" id="dtos_filiat" required="required">
...
<br />
<input type="text" name="ap_interesado" id="ap_interesado" placeholder="APELLIDO" required="required"/>
<input type="text" name="nom_interesado" id="nom_interesado" placeholder="NOMBRE" required="required"/>
<input type="text" name="dni_int" id="dni_int" placeholder="DOCUMENTO" class="solo-numero" required="required"/>
<input type="text" name="est_civil_int" id="est_civil_int" placeholder="ESTADO CIVIL" required="required"/>
<br class="clear" />
<input type="text" name="domicilio_int" id="domicilio_int" placeholder="DOMICILIO" required="required"/>
<input type="text" name="altura_int" id="altura_int" class="altura solo-numero" placeholder="Altura" required="required"/>
...
<br class="clear" />
<input type="text" name="localidad_int" id="localidad_int" placeholder="LOCALIDAD" required="required"/>
<input type="text" name="provincia_int" id="provincia_int" placeholder="PROVINCIA" required="required"/>
<input type="text" name="cp_int" id="cp_int" class="solo-numero" placeholder="CODIGO POSTAL" required="required"/>
<br class="clear" />
<input type="text" name="tel_int" id="tel_int" class="solo-numero" placeholder="TELEFONO" required="required"/>
<input type="text" name="cel_int" id="cel_int" class="solo-numero" placeholder="CELULAR" required="required"/>
<br class="clear" />
<div id="datos_3">
<input type="text" name="ap_pat" id="ap_pat" placeholder="APELLIDO PATERNO" required="required"/>
<input type="text" name="ap_mat" id="ap_mat" placeholder="APELLIDO MATERNO" required="required"/>
<br class="clear" />
</div> <!-- fin datos 3 -->
</div><!-- fin datos 4 -->
<div id="datos_5">
