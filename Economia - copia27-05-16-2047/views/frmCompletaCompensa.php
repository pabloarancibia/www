...
$_SESSION["apynom"];
$id=$_SESSION["nroform"];$anio=$_SESSION["anioform"];
$np=$_SESSION['np'];$rz=$_SESSION["rz"];$mr=$_SESSION["mr"];

?>
<!DOCTYPE html>
<html lang="es">
<head>
<title>Formularios de Compensacion Modificacion</title>
<meta charset="UTF-8">
...
<form id="form1" name="form1" method="post" action="../Logica/ModFormCompensa.php" onsubmit="return chkBC(this)">
...
<?php  echo "<input type='text' style='color:Red;background-color:WhiteSmoke;border-color:LightSkyBlue;border-width:1px;border-style:Solid;font-family:Verdana;font-size:Small;font-weight:bold;width:100% ' readonly='readonly' value='".$id."'>";
?>   </div>  
<strong><div class="col-md-2" align="right" style="width:20%">AÑO FORMULARIO:</div></strong>
<div class="col-md-1" align="left">
<?php  echo "<input type='text' style='color:Red;background-color:WhiteSmoke;border-color:LightSkyBlue;border-width:1px;border-style:Solid;font-family:Verdana;font-size:Small;font-weight:bold;width:100% ' readonly='readonly' value='".$anio."'>";
?>   </div>  
...
<div class="col-md-1" align="left">
<?php  echo "<input type='text' style='color:Red;background-color:WhiteSmoke;border-color:LightSkyBlue;border-width:1px;border-style:Solid;font-family:Verdana;font-size:Small;font-weight:bold;width:100% ' readonly='readonly' value='".$np."'>";
?>
</div>
<strong><div class="col-md-1" align="left" style="width:15%">RAZON SOCIAL:</div></strong>
<div class="col-md-3"><?php  echo "<input type='text' style='color:Red;background-color:WhiteSmoke;border-color:LightSkyBlue;border-width:1px;border-style:Solid;font-family:Verdana;font-size:Small;font-weight:bold;width:100% ' readonly='readonly' value='".$rz."'>";
?>
</div>
</div>
<br>
<div class="row">
   ...
   <div class="col-md-1"><?php  echo "<input type='text' style='color:Red;background-color:WhiteSmoke;border-color:LightSkyBlue;border-width:1px;border-style:Solid;font-family:Verdana;font-size:Small;font-weight:bold;width:100% ' readonly='readonly' value='".$mr."'>";
?></div>
    <div class="col-md-1"></div>
