...
//SI ESTA VACIO NROPROV LE ASIGNO 0 PARA SABER Q ES UN PROV NO INSCRIPTO
...
$precuit=$_POST['cuit1'];$ccuit=$_POST['cuit2'];$postcuit=$_POST['cuit3'];
...
mysqli_close($conexion)or die(mysqli_error($conexion));;
 ...
 $queryGuardar = " INSERT INTO proveedores ( nroProv,cuit, conv_multi, email, nombres, domicilio, localidad, tel, cp,
   ...
   tipo_doc_aut, documento_aut,txt_activ,validado )
 VALUES ( '$nroProv','$cuit', '$conv_multi', '$email', '$nombres', '$domicilio', '$localidad', '$tel', '$cp',
  ...
  '$tipo_doc_aut', '$documento_aut','$clave','$validado') ";
...
if (mysqli_query($conexion,$queryGuardar)){
  ...
  $mail_contendio="Gracias por Registrarte. Para completar el registro tienes que confirmar que has recibido este email haciendo click en el siguiente enlace: ".$url;//
