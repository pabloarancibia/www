...
<div class="form-group" align="center" style="color:red"><h4><strong>EXCLUSIVO PARA USO DE SECRETARIA DE ECONOMIA </strong></h4></div>
<div class="form-group">
    <label for="admin" class="col-sm-5 control-label">D.N.I</label>
    <div class="col-sm-2">
      <input name="adminp" type="text" class="form-control" id="adminp" placeholder="Nro.Documento" onkeypress="return numeros(event)" required="required">
    </div>
</div>
<div class="form-group">
...
<div class="form-group">
   <label for="password_usuario" class="col-sm-5 control-label">Password</label>
    <div class="col-sm-2">
      <input name="password_usuario" type="password" class="form-control" id="password_usuario" placeholder="Clave" required="required">
    </div>
  </div>
  </div>
...
echo "<input type='text' readonly='readonly' value='".$fecha."'>"; ?-->
<table>
<tr>
