...
<title>Listar Documentos Cargados para Compensacionpor Proveedor</title>
...
<!---------------------------------------------->
<form id="form1" name="form1" method="post" action="../views/listaMontoCompensa.php"  target="_blank">
