...
<div id="datos_2">
<input type="text" name="nombres" id="nombres" placeholder="DENOMINACION O RAZON SOCIAL" required="required" style="width:400px"/>
<input type="email" name="email" id="email" required  placeholder="EMAIL" style="width:300px"/><br />
<input type="text" name="domicilio" id="domicilio" placeholder="DOMICILIO: Calle" required="required" style="width:300px"/>
...
<br class="clear" />
<input type="text" name="domicilio_int" id="domicilio_int" placeholder="DOMICILIO: Calle" required="required" style="width:300px"/>
