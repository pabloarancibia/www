...
//tomo el id del pais seleccionado //funciona OK
...
//tengo q recorrer el select de estados, comparar el idPais con el id que tengo en cada option y habilitar o deshabilitar
...
//var indice = 0;
   for (var i = 0; i < selectEst.length; i++) {
    ...
    if (seleccionado == opt.id)
     {
      selectEst.options[i].disabled = false;
    //indice = 0;
  }else{
    
    selectEst.options[i].disabled = true;
    //indice = 1;
    
  }
  //if (indice == 0){
    //selectEst.options[i].remove();
  //}
