...
header("Location: /Economia/views/frmMenuUsuarios.php");
 ...
 else
 {
  ...
  ?>
   <script languaje="javascript">
    ...
    location.href = " http://www.mr.gov.ar/v2/sitio/hacienda/Economia/views/frmLogin.php";
   </script>
  <?php
