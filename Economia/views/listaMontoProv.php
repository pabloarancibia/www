...
function Header()
{
    ...
    $this->SetFont('Arial','B',15);
    $this->SetFont('','U');
    $this->Cell(100,10,'Lista de Montos por Proveedor Presentadas ',0,0,'C'); $this->Ln(10);
	 $this->SetFont('','');
    // Salto de línea
    $this->Ln(10);
}
...
$pdf->Cell(30,8,'Observaciones',1,0,'C');
$pdf->Ln(8);
...
while($fila = mysqli_fetch_array($consulta)){
    ...
    $pdf->Cell(23,8,number_format($fila['montoreclamado'],2,",","."),1,0,'R');
    $pdf->Cell(20,8,number_format($fila['pagosrecibidos'],2,",","."),1,0,'R');
    $pdf->Cell(20,8,number_format($fila['totaldeuda'],2,",","."),1,0,'R');
    $pdf->Cell(30,8,utf8_decode($fila['observaciones']),1,0,'R');
