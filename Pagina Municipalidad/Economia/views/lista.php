...
$pdf->Cell(15,8,'Subr',1,0,'C');
$pdf->Cell(60,8,'desc',1,0,'C');
$pdf->Cell(60,8,'rubro',1,0,'C');
;
...
$conexion=Conectarse();
$query="SELECT * FROM subrubros order by subrubro ASC;";
$consulta = mysqli_query($conexion,$query);

while($fila = mysqli_fetch_array($consulta)){
	$pdf->Cell(15,8,$fila['subrubro'],1,0,'C');
    $pdf->Cell(60,8,utf8_decode($fila['subrubdesc']),1,0,'C');
 $pdf->Cell(15,8,$fila['irubro'],1,0,'C');
    $pdf->Ln(8);
}
