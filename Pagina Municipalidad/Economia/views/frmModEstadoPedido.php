...
<title>Modificar Estado de Pedido de Materiales</title>
    ...
    <div class="registros" id="agrega-registros">
        <table class="table table-striped table-condensed table-hover">
         <tr>
          ...
          <th width="80">AÑO</th>
          <th width="400">SOLICITANTE</th>
          <th width="400">USO DEL MATERIAL</th>
          ...
          <?php
            ...
            $conexion=Conectarse();
            $queryu="SELECT * FROM pedidomateriales ORDER BY aniopedido desc,nropedido desc";
