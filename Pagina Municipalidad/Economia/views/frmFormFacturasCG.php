...
<title>Listar Facturas cargadas con Gestion Judicial</title>
...
<!---------------------------------------------->
<form id="form1" name="form1" method="post" action="../views/listaFormularioCG.php"  target="_blank">
...
<body>
    ...
    <table border="0" align="center">
        ...
        <tr>
		   <td>Ingrese Apellido y Nombre Demandante:</td>
