...
<form id="form1" name="form1" method="post" action="../Logica/ModificarUsuarios.php" onsubmit="return chkBC(this)">
...
<section align="center">
 <table border="0" align="center">
   <tr>
    <td width="335"><input type="text" placeholder="Ingrese Proveedor"  name="nroprov" id="nroprov"/></td>
...
<div class="row">
  <div class="col-md-4"></div>
   <strong><div class="col-md-2">CLAVE NUEVA:</div></strong>
