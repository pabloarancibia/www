...
if (!isset($_SESSION["usuario"])){
    header("Location:http://www.mr.gov.ar/v2/sitio/hacienda/Economia/views/index.php?nologin=false");}
$_SESSION["usuario"];
...
<html lang="es">
<head>
<title>Alta de Acreedores Excepcionales</title>
<meta charset="UTF-8">
...
<form id="form1" name="form1" method="post" action="../Logica/AltaProveedorWT.php"   onsubmit="return chkBC(this)">
