...
<title>Listar Documentos cargadas sin Gestion judicial por Proveedor</title>
...
<!---------------------------------------------->
<form id="form1" name="form1" method="post" action="../views/listaFormularioSG.php"  target="_blank">
...
<body>
    ...
    <table border="0" align="center">
        ...
        <tr>
		   <td>Ingrese Número de Proveedor:</td>
		   <td><input type="text" required="required" name="bsprov" id="bsprov" maxlength="100"/></td>
     	   <td>Ingrese Número de Documento:</td>
           <td><input type="text" required="required" name="nrodni" id="nrodni" maxlength="100"/></td>
