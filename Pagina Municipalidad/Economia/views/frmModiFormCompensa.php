...
<html lang="es">
<head>
<title>Modificacion de Estado de Documentos de Acreedores</title>
<meta charset="UTF-8">
...
<form id="form1" name="form1" method="post" action="../Logica/ConsultaEstadoCompensa.php" onsubmit="return chkBC(this)">
...
<input name="nroform" id="nroform" type='text'  style='color:black;background-color:WhiteSmoke;border-color:LightSkyBlue;border-width:1px;border-style:Solid;font-family:Verdana;font-size:Small;font-weight:bold;width:100%' onkeypress="return numeros(event)" required="required" />
</div>
<strong><div class="col-md-2" align="right" style="width:20%">AÑO FORMULARIO:</div></strong>
<div class="col-md-1" align="left">
<input name="anioform" id="anioform" type='text'  style='color:black;background-color:WhiteSmoke;border-color:LightSkyBlue;border-width:1px;border-style:Solid;font-family:Verdana;font-size:Small;font-weight:bold;width:100%' onkeypress="return numeros(event)" required="required" />
</div>
</div>
<br>
 <br>
