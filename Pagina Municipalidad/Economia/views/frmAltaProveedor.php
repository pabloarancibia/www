...
<form id="form1" name="form1" method="post" action="../Logica/AltaProveedor.php" onsubmit="return chkBC(this)">
...
<strong><div class="col-md-1" align="right" style="width:15%">(*)RAZON SOCIAL:</div></strong>
...
<div class="row">
   ...
   <div class="col-md-2"><input name="apellido" type="text" id="apellido" style="text-transform:uppercase;color:Black;background-color:WhiteSmoke;border-color:LightSkyBlue;border-width:1px;border-style:Solid;font-family:Verdana;font-size:Small;font-weight:bold;" 
   ...
   <div class="col-md-2"><input name="nombre" type="text" id="nombre" style="text-transform:uppercase;color:Black;background-color:WhiteSmoke;border-color:LightSkyBlue;border-width:1px;border-style:Solid;font-family:Verdana;font-size:Small;font-weight:bold;" 
    onkeyup="javascript:this.value=this.value.toUpperCase();" maxlength="55" required="required"/></div>
   <strong><div class="col-md-1" align="left" style="width:8%;">(*)CONYUGE:</div></strong>
   <div class="col-md-2"><input name="conyuge" type="text" id="conyuge" style="text-transform:uppercase;color:Black;background-color:WhiteSmoke;border-color:LightSkyBlue;border-width:1px;border-style:Solid;font-family:Verdana;font-size:Small;font-weight:bold;" 
