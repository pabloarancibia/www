...
<form id="form1" name="form1" method="post" action="../Logica/AltaProveedorEx.php" onsubmit="return chkBC(this)">
...
<strong><div class="col-md-2" align="left" style="width:20%">(*)NRO.PROVEEDOR:</div></strong>
...
<div class="row">
<div class="col-md-3"></div>
<strong><div class="col-md-2" align="left" style="width:20%">(*)USER:</div></strong>
<div class="col-md-1"><input name="usern" type="text" id="usern" style="text-transform:uppercase;color:Black;background-color:WhiteSmoke;border-color:LightSkyBlue;border-width:1px;border-style:Solid;font-family:Verdana;font-size:Small;font-weight:bold;width:100%;" 
    onkeyup="javascript:this.value=this.value.toUpperCase();" required="required"/>
</div>
</div><br>
<div class="row">
<div class="col-md-3"></div>
<strong><div class="col-md-2" align="left" style="width:20%">(*)CLAVE:</div></strong>
 <div class="col-md-1"><input name="clu" id="clu" type='text' style='color:Black;background-color:WhiteSmoke;border-color:LightSkyBlue;border-width:1px;border-style:Solid;font-family:Verdana;font-size:Small;font-weight:bold;width:110%;' onkeypress="return numeros(event)" required="required"/></div>
   </div>
<br></div><br>
</div><br><br><br>
