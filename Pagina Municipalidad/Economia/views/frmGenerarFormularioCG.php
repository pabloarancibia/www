...
<html lang="es">
<head>
<title>Generacion de Numeracion de Formularios de Acreedores</title>
<meta charset="UTF-8">
...
<form id="form1" name="form1" method="post" action="../Logica/AltaFormularioCG.php" onsubmit="return chkBC(this)">
...
<?php include "../Conexion/Conexion.php";
      ...
      $query="SELECT anio,numero FROM nroformcg";
...
<strong><div class="col-md-2" align="left" style="width:15%">NOMBRE/RAZON SOCIAL:</div></strong>
<div class="col-md-3"><input name="ayn" type="text" id="ayn" style="text-transform:uppercase;color:Black;background-color:WhiteSmoke;border-color:LightSkyBlue;border-width:1px;border-style:Solid;font-family:Verdana;font-size:Small;font-weight:bold;width:100%;" 
...
<div class="row">
   ...
   <strong><div class="col-md-2" align="left">MONTO ORIGINAL $:</div></strong>
...
<div class="row">
   <div class="col-md-1"></div>
   <strong><div class="col-md-2" align="left" >HONORARIOS REGULADOS $:</div></strong>
   <div class="col-md-1"><input name="hr" type="text" id="hr" style="text-transform:uppercase;color:Black;background-color:WhiteSmoke;border-color:LightSkyBlue;border-width:1px;border-style:Solid;font-family:Verdana;font-size:Small;font-weight:bold;" 
    onkeypress="return numeros(event)" required="required"/></div>
  </div><br>
<div class="row">
   <div class="col-md-1"></div>
   <strong><div class="col-md-2" align="left" >COSTAS REGULADAS $:</div></strong>
   <div class="col-md-1"><input name="cr" type="text" id="cr" style="text-transform:uppercase;color:Black;background-color:WhiteSmoke;border-color:LightSkyBlue;border-width:1px;border-style:Solid;font-family:Verdana;font-size:Small;font-weight:bold;" 
    onkeypress="return numeros(event)" required="required"/></div>
  </div><br>

<div class="row">
   <div class="col-md-1"></div>
   <strong><div class="col-md-2" align="left" >TOTAL DEUDA RECLAMADA $:</div></strong>
   <div class="col-md-1"><input name="totald" type="text" id="totald" style="text-transform:uppercase;color:Black;background-color:WhiteSmoke;border-color:LightSkyBlue;border-width:1px;border-style:Solid;font-family:Verdana;font-size:Small;font-weight:bold;" 
    onkeypress="return numeros(event)" required="required"/></div>
  </div>
  <br>
   <div class="row">
   <div class="col-md-1"></div>
  <strong><div class="col-md-2" align="left">OBSERVACIONES:</div></strong>
<div class="col-md-6"><input name="observa" type="text" id="observa" style="text-transform:uppercase;color:Black;background-color:WhiteSmoke;border-color:LightSkyBlue;border-width:1px;border-style:Solid;font-family:Verdana;font-size:Small;font-weight:bold;width:100%;" 
