...
$pdf->Cell(220,8,utf8_decode('SOLICITUD DE AUTORIZACION DE HORAS EXTRAS A PRESTAR'),0,0,'L');
$pdf->Ln(5);
...
$pdf->SetFont('Arial','',8);
$pdf->Ln(8);
$pdf->Cell(0,8,utf8_decode(' Por medio de la presente se solicita autorización para que los agentes dependientes de este área realicen Horas Extras en el período solicitado, ségún el siguiente detalle.'),0,1,'L');
$pdf->Ln(2);
...
$pdf->Cell(20,5,'PER.SOLICITADO',1,'T','C');
$pdf->Cell(10,5,'HS.S.',1,'T','C');$pdf->Cell(10,5,'HS.D',1,'T','C');
$pdf->Cell(20,5,'TOT.SOLICITADO',1,'T','C');
...
$pdf->Cell(35,5,'Total Horas Per.Solicitado:',0,'T','C');
//$pdf->Cell(105,5,'',0,'T','L');//$pdf->Cell(145,5,utf8_decode($totalletra),0,'T','L');
$pdf->Cell(20,5,'70',0,'T','R');//$pdf->Cell(35,5,chr(36).' '.number_format($tmontof,2,",","."),0,'T','C');
$pdf->Ln(5);
