...
<html lang="es">
<head>
<title>Modificacion de Estado de Mesa de Entradas</title>
<meta charset="UTF-8">
...
<form id="form1" name="form1" method="post" action="../Logica/ConsultaEstadoME.php" onsubmit="return chkBC(this)">
...
<br>
<div class="row">
<strong><div class="col-md-2" align="right" style="width:20%">TRAMITE MESA ENTRADA:</div></strong>
<div class="col-md-1" align="left">
<input name="nroME" id="nroME" type='text'  style='color:black;background-color:WhiteSmoke;border-color:LightSkyBlue;border-width:1px;border-style:Solid;font-family:Verdana;font-size:Small;font-weight:bold;width:100%' onkeypress="return numeros(event)" required="required" />
</div>
<strong><div class="col-md-2" align="right" style="width:20%">AÑO MESA ENTRADA:</div></strong>
<div class="col-md-1" align="left">
<input name="ame" id="ame" type='text'  style='color:black;background-color:WhiteSmoke;border-color:LightSkyBlue;border-width:1px;border-style:Solid;font-family:Verdana;font-size:Small;font-weight:bold;width:100%' onkeypress="return numeros(event)" required="required" />
</div>
