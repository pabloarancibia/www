...
$_SESSION["apynom"];$_SESSION["secretaria"];
 if((!empty($_SESSION["razon"]))||(!empty($_SESSION["bddesde"]))
  ||(!empty($_SESSION["bdhasta"]))||(!empty($_SESSION["nroformd"]))
  ||(!empty($_SESSION["nroformh"]))||(!empty($_SESSION["nroprovd"]))
  ||(!empty($_SESSION["nroprovh"]))) 
  { unset($_SESSION["razon"]); unset($_SESSION["bddesde"]);
    unset($_SESSION["bdhasta"]);unset($_SESSION["nroformd"]);
    unset($_SESSION["nroformh"]);unset($_SESSION["nroprovd"]);
...
<title>Pedidos de Compensaciones de Proveedores</title>
...
<form  id="form1" name="form1" method="post" action="../Logica/ProcesarMoComp.php">
 ...
 <br>
 <div class="row">
  <strong><div class="col-md-3">Por Fecha de Presentacion</div> </strong>
 ...
 <div class="row">
  <strong><div class="col-md-3">Por Formulario Presentado</div> </strong>
  <div class="col-md-1"><input type="checkbox" name="bfp" onclick="criterios()"></div>
  <div class="col-md-3"><input type="text" placeholder="Ingrese Nro.del Formulario" id="nroformd" name="nroformd" disabled="true" style="width:70%" onkeypress="return numeros(event)"/>&nbsp&nbsp&nbspHasta</div>
  <div class="col-md-3"><input type="text" placeholder="Ingrese Nro.del Formulario" id="nroformh" name="nroformh" disabled="true" style="width:70%" onkeypress="return numeros(event)"/></div>
