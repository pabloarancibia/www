...
<html lang="es">
<head>
<title>Alta de Acreedor por Compensación</title>
<meta charset="UTF-8">
...
<form id="form1" name="form1" method="post" action="../Logica/AltaCompensa.php" onsubmit="return chkBC(this)">
...
<strong><div class="col-md-1" align="left" style="width:8%">(*)C.P:</div></strong>
   <div class="col-md-1"><input name="cp" type="text" id="cp" style="color:Black;background-color:WhiteSmoke;border-color:LightSkyBlue;border-width:1px;border-style:Solid;font-family:Verdana;font-size:Small;font-weight:bold;width:70%;" maxlength="10" /></div>
