...
<div class="collapse navbar-collapse" id="navbar-1">
 ...
 <li class="dropdown">
   <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button">VOLVER A SELECCIONAR CRITERIOS<span class="caret"></span></a>
    ...
    <li><a href="../views/frmMoComp.php">Menú</a>
    </li>
   </ul>
 </li>
 </ul>
...
border: 10px solid #ffffff;">
 <section>
  <table border="0" align="center">
   ...
   <td width="150"><a href="../views/explistaMontoCompensa.php" class="btn btn-primary">EXCEL</a></td>
   <td width="150"><a target="_blank" href="../views/listaMontoCompensa.php" class="btn btn-danger">PDF</a></td>
   </tr>
  </table>
 </section>
 ...
 <table class="table table-striped table-condensed table-hover">
  ...
  <th width="100">PRESENTADO</th>
  <th width="100">FORMULARIO</th>
  <th width="100">AÑO</th>
  <th width="200">SOLICITADO $</th>
  <th width="220">AUTORIZADO $</th>
  <th width="200">SALDO PROVEEDOR $</th>
 ...
 <?php
  ...
  <td align=right>'.$row['montoautorizado'].'</td>
  <td align=right>'.$row['saldoprov'].'</td>
  </tr>';
  $conteo++;
      $tmontof=$tmontof+$row['montoreclamado'];$tpagp=$tpagp+$row['montoautorizado'];
    $tmontot=$tmontot+$row['saldoprov'];
  }
  ?>
</table>
  ...
  <table class="table table-striped table-condensed table-hover">
   <tr>
    <td><h4>SOLICITADO $:</h4></td><td><h5><?php echo $tmontof;?></h5></td>
    <td><h4>AUTORIZADO $:</h4></td><td><h5><?php echo $tpagp;?></h5></td>
    <td><h4>SALDO A PROVEEDORES $:</h4></td><td><h5><?php echo $tmontot;?></h5></td>
   </tr>
  </table>
    </div>
    <br>
