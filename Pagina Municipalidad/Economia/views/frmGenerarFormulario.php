...
<form id="form1" name="form1" method="post" action="../Logica/AltaFormulario.php" onsubmit="return chkBC(this)">
...
<?php include "../Conexion/Conexion.php";
      ...
      $query="SELECT anio,numero FROM nroform";
...
<div class="row">
   ...
   <strong><div class="col-md-2" align="left">MONTO RECLAMADO $:</div></strong>
...
<div class="row">
   <div class="col-md-1"></div>
   <strong><div class="col-md-2" align="left" >PAGOS PARCIALES RECIBIDOS $:</div></strong>
   <div class="col-md-1"><input name="pagosp" type="text" id="pagosp" style="text-transform:uppercase;color:Black;background-color:WhiteSmoke;border-color:LightSkyBlue;border-width:1px;border-style:Solid;font-family:Verdana;font-size:Small;font-weight:bold;" 
    onkeypress="return numeros(event)" required="required"/></div>
  </div><br>
<div class="row">
   <div class="col-md-1"></div>
